    ...
    <div className='col text-center text-primary'>
      ...
      <div className='col'>
        ...
        <div className="founder1 row ">
            ...
            <p className='text-white'>Meet the team behind Askema Engineering. Machanical Engineering 
            Meet the team behind Askema Engineering. Machanical Engineering
            Meet the team behind Askema Engineering. Machanical Engineering 
            Meet the team behind Askema Engineering. Machanical Engineering
            Meet the team behind Askema Engineering. Machanical Engineering 
            Meet the team behind Askema Engineering. Machanical Engineering </p>
            </div>
